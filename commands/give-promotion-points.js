 ...
 */
async function givePromotionPoints(
  interaction
) {
  /**
  ...
  */
  ...
  if (
    ...
    return console.error(
      "give promotion points: maker or taker undefined"
    );
  }
  ...
  if (
    ...
    return console.error(
      "give promotion points: maker role or taker role undefined"
    );
  }
  const points = interaction.options.getNumber(
    "points"
  );
  ...
  message.setDescription(
    `${makerRole} *${maker}* give ${points} *${pointsString}* to ${takerRole} *${taker}*`
  );
  message.addFields(
    {
